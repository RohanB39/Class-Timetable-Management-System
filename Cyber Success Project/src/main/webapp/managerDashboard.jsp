...
<body>
	<div class="dashboard">
		...
		<div class="main-content">
			...
			<div class="buttons" style="height: 21vh;">
				<div class="create-tt">
					<i class="fas fa-plus" style="color: #4caf50;"><a
						href="createTimetable.jsp">Create Timetable</a></i>
				</div>
				<div class="create-tt">
					<i class="fas fa-calendar-alt" style="color: #e91e63;"><a
						href="#">All Timetables</a></i>
				</div>
				<div class="create-tt">
					<i class="fas fa-user-check icon-attendance"><a href="#">Check
							Attendance</a></i>
				</div>
				<div class="create-tt">
					<i class="fas fa-user icon-profile"><a href="#">Profile</a></i>
				</div>
			</div>

			<div class="buttons" style="height: 21vh;">
				<div class="create-tt">
					<i class="fas fa-plus-circle icon-add" style="color: #e342f5;"><a href="AddBatch.jsp">Add Batch</a></i>
				</div>
				<div class="create-tt">
					<i class="fas fa-compress-alt" style="color: #8da600;"><a href="MeargeBatch.jsp">Merge Batch</a></i>
				</div>
				<div class="create-tt">
					<i class="fas fa-trash" style="color: #a6000b;"><a href="DeleteBatch.jsp">Delete Batch</a></i>
				</div>
				<div class="create-tt">
					<i class="fas fa-eye" style="color: #a6008a;"><a href="BatchDetails.jsp">Batch Details</a></i>
				</div>
			</div>
